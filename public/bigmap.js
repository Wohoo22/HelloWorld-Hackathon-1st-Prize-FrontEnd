...
function drawMap() {
  ctx.drawImage(lavaImg, 0, 0, 1400, 1400)
}
...
function generate() {
  axios.get("https://" + ngrok + ".ngrok.io/map/generate-big?size=21&hasMom=false").then((res) => {
...
async function sendCode() {
  ...
  await $.ajax({
    url: "https://" + ngrok +".ngrok.io/map/check-big",
    type: "post",
    dataType: "json",
